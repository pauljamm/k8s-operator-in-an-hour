...
# mcs.mail.ru/k8s-operator-in-an-hour-bundle:$VERSION and mcs.mail.ru/k8s-operator-in-an-hour-catalog:$VERSION.
IMAGE_TAG_BASE ?= mcs.mail.ru/k8s-operator-in-an-hour
